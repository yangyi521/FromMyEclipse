...
<div class="main">
	...
	<form method="post" action="bookDal?method=remove">
	<div class="content">
			<table class="box">
			<tr style="width: 396px; ">
					<td class="field" style="width: 150px; ">要删书的ISBN号：</td>
					<td><input type="text" name="ISBN" class="text" onblur="isInteger(this.value,'ISBN')"/><span id="ISBN"></span></td>
				</tr>
				
				<tr>
                <td colspan="2" style="width: 357px; "><span><%if(null!=request.getAttribute("info")){
